...
int main(int argc, char* argv[]) {
  ...
  auto l2 = cache_gen_inc<L2IW, L2WN, data_type, MetadataBroadcastBase, ReplaceLRU, MSIPolicy, policy_l2, false, void, false, true>(MCore, "l2");
  auto l3 = cache_gen_inc<L3IW, L3WN, data_type, MetadataBroadcastBase, ReplaceLRU, MSIPolicy, policy_l3, true, void, false, true>(1, "llc")[0];
  ...
  ParallelRegressionGen<true, false, PAddrN, SAddrN, data_type> tgen(NCore);
  ...
  std::cout << "Cache Level: " << 3 << std::endl;
