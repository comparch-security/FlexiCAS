...
int main(int argc, char* argv[]) {
  ...
  if (argc != 2) {
    std::cerr << "Usage replay_three_level <trace_dir>" << std::endl;
    return 0;
  }
  ...
  auto l2 = cache_gen_inc<L2IW, L2WN, void, MetadataBroadcastBase, ReplaceLRU, MSIPolicy, policy_l2, false, DelayCoherentCache<2, 3, 4>, true, true>(NCore, "l2");
  auto l3 = cache_gen_inc<L3IW, L3WN, void, MetadataBroadcastBase, ReplaceLRU, MSIPolicy, policy_l3, true, DelayCoherentCache<4, 5, 6>, true, true>(1, "llc")[0];
  ...
  std::cout << "replay_three_level_st: " << NThread << " " << NCore << std::endl;
